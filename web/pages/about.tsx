  ...
  return (
    <div className='p-8'>
      ...
      <div className='mt-4 text-lg'>
        <div >Inspired by projects like <LinkTag href={"https://www.arxiv-vanity.com/"}>Arxiv-Vanity</LinkTag>, <LinkTag href="https://paperswithcode.com/">Papers With Code</LinkTag>, <LinkTag href="https://github.com/karpathy/arxiv-sanity-preserver">ArXiv-Sanity</LinkTag>, <LinkTag href="https://www.connectedpapers.com/">Connected Papers</LinkTag>, and <LinkTag href="https://www.semanticscholar.org/">Semantic Scholar</LinkTag>, we are building a platform to aid and enrich the research experience for machine learning. Browse new papers on the home page, search for papers, find papers that are similar, and save papers to your personal library.</div>
        <div>We use <Link href="https://arxiv.org/pdf/2004.07180.pdf"><span className='underline cursor-pointer'>SPECTER</span></Link> embeddings of each paper and perform an approximate nearest neighbor search on the embedding of the paper to find similar papers.</div> 
        </div>
    </div>
  )
}
...
function LinkTag({href,children}){
  return <Link href={href}><span className='underline cursor-pointer'>{children}</span></Link> 
}
